...
describe "The while expression" do
  ...
  # NATFIXME: This fails until we capture it with a NATFIXME block
  xit "stops running body if interrupted by break in a parenthesized attribute op-assign-or value" do
    a = mock("attribute assignment break")
  ...
  # NATFIXME: This fails until we capture it with a NATFIXME block
  xit "stops running body if interrupted by break in a begin ... end attribute op-assign-or value" do
    a = mock("attribute assignment break")
    a.should_receive(:m).and_return(nil)
    a.should_not_receive(:m=)
