...
describe "NoMethodError#message" do
  ...
  it "uses #name when receiver is a class" do
    ...
    begin
      ...
      NATFIXME 'it uses #name when receiver is a class', exception: SpecFailedException do
  ...
  it "uses #name when receiver is a module" do
    ...
    begin
      ...
      NATFIXME 'it uses #name when receiver is a module', exception: SpecFailedException do
  ...
  it "uses class #name when receiver is an ordinary object" do
    ...
    begin
      ...
      NATFIXME 'it uses class #name when receiver is an ordinary object', exception: SpecFailedException do
  ...
  it "uses class name when receiver has a singleton class" do
    ...
    begin
      ...
      NATFIXME 'it uses class name when receiver has a singleton class', exception: SpecFailedException do
