...
describe "Proc#lambda?" do
  ...
  it "returns true for a Method converted to a Proc" do
    m = :foo.method(:to_s)
    NATFIXME 'it returns true for a Method converted to a Proc', exception: SpecFailedException do
  ...
  it "is preserved when a Proc is curried" do
    NATFIXME 'Implement Proc#curry', exception: NoMethodError, message: "undefined method 'curry' for an instance of Proc" do
